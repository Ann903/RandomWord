<template>
    <el-container>
      <el-header>
        <i class="el-icon-s-operation"  @click="drawer = true" type="primary" style="margin-left: 16px;"> Ann's</i>
        <div class="demo-image__preview">
          <el-image :src="url" :preview-src-list="srcList" class="header-image">
          </el-image>
        </div>
        <div class="divider">
          <span>
      ...
      <audio autoplay="autoplay" controls="controls" preload="auto" src="../assets/HeySong.mp3" loop="true" hidden="true"></audio>
    </el-container>
</template>
...
export default {
  ...
  mounted () {
    ...
    axios({
      method: 'GET',
      url: 'https://api.12ms.xyz/getrand',
      responseType: 'json'
    }).then(function (res) {
      // console.log(that)
